...
exports.findSpanRootLocation = void 0;
// span root must be the top-left cell of the spanned area
const findSpanRootLocation = (tableNode, currentLocation) => {
    if (currentLocation.length !== 2) {
        // malformed target
        console.error("currentLocation is malformed", currentLocation);
        return null;
    }
    const cell = tableNode.children[currentLocation[0]]?.children[currentLocation[1]];
    if (!cell) {
        return null;
    }
...
exports.findSpanRootLocation = findSpanRootLocation;
